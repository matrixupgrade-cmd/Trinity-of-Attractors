/-!
  ...
  Complete three-way phase classification of every possible orbit:
...
-- ==================================================================
-- 3–4. Candidates, Scoring & Metamorphosis
-- ==================================================================
...
-- ==================================================================
-- 6. The Complete Phase Trichotomy
-- ==================================================================

/-- Plasma  – complexity diverges to infinity -/
def Plasma : Prop := ∀ N : ℕ, ∃ n, Comp n ≥ N

/-- Liquid  – complexity bounded and the MetaState orbit is eventually periodic -/
def Liquid : Prop :=
  ∃ C n₀ p, p ≠ 0 ∧ ∀ n ≥ n₀, Comp n ≤ C ∧ MetaOrbit (n + p) = MetaOrbit n

/-- Diamond – the MetaState eventually freezes forever -/
...
theorem phase_trichotomy : Plasma ∨ Liquid ∨ Diamond := by
  ...
  · push_neg at h_plasma
    ...
    -- Bounded complexity implies bounded number of spiders
    let K := ⌈C / 4⌉₊
